...
export const ShowAllEmployee = async () => {
    try {
      const response = await instance.get('/operation/Asbuilt');
  ...
  export const showEmployee = async (id) => {
    try {
      const response = await instance.get('/operation/Asbuilt/'+id);
      return response.data;
    } catch (error) {
      throw new Error('data failed');
    }
  ...
  export const DeleteEmployee = async (id) => {
    try {
      const response = await instance.delete('/operation/Asbuilt/'+id);
      return response.data;
    } catch (error) {
      throw new Error('data failed');
    }
  ...
  export const UpdateEmployees = async (formdata , id) => {
    try {
      const response = await instance.post('/operation/Asbuilt/'+id+'/update',formdata);
      return response.data;
    } catch (error) {
      throw new Error('data failed');
    }
