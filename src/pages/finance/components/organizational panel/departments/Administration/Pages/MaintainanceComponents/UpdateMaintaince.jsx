...
const UpdateMaintainanceDialog = ({
  openUpdateDialog,
  setOpenUpdateDialog,
  formDataUpdate,
  setFormDataUpdate,
  ...
  return (
    <Dialog fullWidth='lg' open={openUpdateDialog} onClose={() => setOpenUpdateDialog(false)}>
      ...
      <DialogContent>
        ...
        {/* Maintainance Name Input */}
        <FormControl fullWidth margin="normal">
          <TextField
            label="Maintainance Name"
            name="name"
            fullWidth
            margin="dense"
...
export default UpdateMaintainanceDialog;
